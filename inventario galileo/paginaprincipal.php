...
<body>
    ...
    <div class="button-container">
      <a href="index.php" class="button" onclick="logout()">log out</a>
    </div>
    </nav><!----------------------------------------------------------------------------------------------------------------------->
  ...
  <div class="dolar" style="display: inline-flex;margin-left: 250px;"><!---------------------Dolres-------------------------------->
    <form action="actualizar_precios.php" method="POST">
      <input type="number" name="valor_dolar" placeholder="Ingresar valor del dólar"><!-- entrada del valor del precio del dolar -->
      <input type="submit" value="Actualizar precios" style="background-color: rgb(31, 182, 132);position: relative;padding: 10px 15px;margin: 10px;font-size: 16px;cursor: pointer;border: none;background-color: rgba(44, 109, 42, 0.842);color: #ffffff;text-decoration: none;transition: background-color 0.3s, color 0.3s;"><!-- boton de actualizacion del precio ingresado-->
    </form>
</div><!--------------------------------------------------------------------------------------------------------------------------->
